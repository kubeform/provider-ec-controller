module kubeform.dev/provider-ec-controller
...
require (
	...
	kubeform.dev/provider-ec-api v0.4.1-0.20220317074914-fcddd1b3e0a0
...
require (
	...
	github.com/elastic/cloud-sdk-go v1.8.1 // indirect

...
// +kubebuilder:rbac:groups=deployment.ec.kubeform.com,resources=extensions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=deployment.ec.kubeform.com,resources=extensions/status,verbs=get;update;patch
...
func (r *ExtensionReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &deploymentv1alpha1.Extension{}); err != nil {
			klog.Error(err, "unable to set up auditor", deploymentv1alpha1.Extension{}.APIVersion, deploymentv1alpha1.Extension{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&deploymentv1alpha1.Extension{}).

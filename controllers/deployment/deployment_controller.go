...
// +kubebuilder:rbac:groups=deployment.ec.kubeform.com,resources=deployments,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=deployment.ec.kubeform.com,resources=deployments/status,verbs=get;update;patch
...
func (r *DeploymentReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &deploymentv1alpha1.Deployment{}); err != nil {
			klog.Error(err, "unable to set up auditor", deploymentv1alpha1.Deployment{}.APIVersion, deploymentv1alpha1.Deployment{}.Kind)
			return err
		}
	}
...
func (r *DeploymentReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for Deployment")
			return nil
		}
		...
		resourceList := &deploymentv1alpha1.DeploymentList{}
